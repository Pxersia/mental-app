...
(101, 'camila.rojas@abrazamente.cl', '$2a$10$wE9lE78g1n...hash', '15.234.567-8', 'Camila', 'Rojas', 'Mujer', 'Especialista en manejo de ansiedad y estrés con enfoque practico y basado en evidencia.', 'activo'),
(102, 'andres.fuenzalida@abrazamente.cl', '$2a$10$wE9lE78g1n...hash', '16.345.678-9', 'Andres', 'Fuenzalida', 'Hombre', 'Enfocado en el crecimiento personal y la exploracion emocional.', 'activo'),
(103, 'valentina.soto@abrazamente.cl', '$2a$10$wE9lE78g1n...hash', '14.123.456-7', 'Valentina', 'Soto', 'Mujer', 'Trabaja con dinamicas familiares complejas, mediacion y resolucion de conflictos.', 'activo'),
(104, 'martin.ibanez@abrazamente.cl', '$2a$10$wE9lE78g1n...hash', '17.456.789-0', 'Martin', 'Ibañez', 'Hombre', 'Especialista en conflictos de pareja, comunicacion y reconstruccion de confianza.', 'activo'),
(105, 'fernanda.munoz@abrazamente.cl', '$2a$10$wE9lE78g1n...hash', '18.567.890-1', 'Fernanda', 'Muñoz', 'Mujer', 'Amplia experiencia en trastornos de ansiedad y tecnicas de respiracion.', 'activo'),
(106, 'ignacio.pardo@abrazamente.cl', '$2a$10$wE9lE78g1n...hash', '19.678.901-2', 'Ignacio', 'Pardo', 'Hombre', 'Trabaja con procesos de duelo, desmotivacion y episodios depresivos.', 'activo');
