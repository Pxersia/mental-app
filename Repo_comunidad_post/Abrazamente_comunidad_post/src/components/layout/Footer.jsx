...
export default function Footer() {
  return (
    <footer className="mente-footer w-full pt-10 pb-6 px-6 md:px-12 mt-auto relative z-10">
      <div className="max-w-[1200px] mx-auto w-full">
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-8 mb-8">
          {/* Marca */}
          <div className="flex flex-col gap-4 lg:pr-6">
            ...
            <p className="text-[0.9rem] leading-relaxed text-[var(--text-muted)] mt-1 max-w-sm">
              Plataforma de bienestar emocional con apoyo profesional, herramientas guiadas y una comunidad cuidada.
            </p>
          </div>
        ...
        <div className="border-t border-gray-200/40 dark:border-gray-800/60 pt-5 flex flex-col md:flex-row items-center justify-center gap-3">
          <p className="text-[0.85rem] text-[var(--text-muted)] font-medium text-center w-full">
            AbrazaMente SpA <span className="mx-2">•</span> Diseñado por <strong>Grupo 1</strong> <span className="mx-2">•</span> 
