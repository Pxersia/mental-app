...
import { Calendar, User, LogOut, Home, CheckCircle, Clock, BookOpen } from 'lucide-react';
...
export default function ProfilePage() {
  ...
  const glass = {
    background: isDark ? 'rgba(30,30,32,0.72)' : 'rgba(255,255,255,0.72)',
  ...
  useEffect(() => {
    const getLocalSesiones = () => {
      try {
        return JSON.parse(localStorage.getItem(sesionesKey) || '[]');
      } catch {
        return [];
      }
    };
  ...
  const handleCancelarSesion = (id) => {
    ...
    try {
      ...
      localStorage.setItem(sesionesKey, JSON.stringify(actualizadas));
    } catch (err) {
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
        ...
        {location.state?.registered && (
          <div style={{
            ...
            color: isDark ? '#7ae0ee' : '#007a8a', fontSize: '0.9rem', fontWeight: 600,
          }}>
        ...
        {/* Profile Hero Card */}
        <div style={{
          ...glass, backdropFilter: 'blur(28px)',
          WebkitBackdropFilter: 'blur(28px)', borderRadius: '32px', padding: '36px', marginBottom: '24px',
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{
              ...
              color: 'var(--text-muted)', background: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.5)',
              padding: '4px 12px', borderRadius: '100px', border: isDark ? '1px solid rgba(255,255,255,0.12)' : '1px solid rgba(255,255,255,0.8)',
              marginBottom: '10px',
            }}>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            ...
            <button
              ...
              style={{
                display: 'flex', alignItems: 'center', gap: '6px',
                padding: '10px 20px', borderRadius: '14px', border: isDark ? '1px solid rgba(255,255,255,0.12)' : '1px solid rgba(134,134,139,0.2)',
                background: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.5)', color: 'var(--text-muted)',
        ...
        <div style={{
          ...glass, backdropFilter: 'blur(28px)',
          WebkitBackdropFilter: 'blur(28px)', borderRadius: '32px', padding: '32px', marginBottom: '24px',
          boxShadow: '0 20px 60px rgba(0,0,0,0.08)',
        }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '16px' }}>
            {[
              ...
              <div key={label} style={{
                ...subGlass, borderRadius: '16px', padding: '16px',
              }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center',
            boxShadow: '0 10px 28px rgba(77,208,225,0.28)',
          }}>
            <BookOpen style={{ width: '28px', height: '28px' }} />
          </div>
          <div style={{ flex: 1, minWidth: 0 }}>
            <h2 style={{ fontSize: '1.1rem', fontWeight: 800, color: 'var(--text-main)', margin: '0 0 6px', letterSpacing: '-0.02em' }}>
              Mi diario
            </h2>
            <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', margin: 0, lineHeight: 1.5 }}>
              Registra cómo te sientes cada día, revisa tu historial y sigue tu tracker de ánimo.
            </p>
          </div>
          <Link
            to="/journal"
            style={{
              ...
              color: 'white', textDecoration: 'none', fontSize: '0.92rem', fontWeight: 700,
              boxShadow: '0 8px 24px rgba(77,208,225,0.3)',
            }}
          >
        ...
        <div style={{
          ...glass, backdropFilter: 'blur(28px)',
          WebkitBackdropFilter: 'blur(28px)', borderRadius: '32px', padding: '32px',
          boxShadow: '0 20px 60px rgba(0,0,0,0.08)',
        }}>
          ...
          {loadingSesiones ? (
            ...
            <div style={{
              ...
              background: isDark ? 'rgba(255,255,255,0.04)' : 'rgba(255,255,255,0.4)', borderRadius: '20px',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {sesiones.map(sesion => (
                <div key={sesion.id} style={{
                  ...
                  padding: '18px 20px', border: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(255,255,255,0.8)',
                  borderRadius: '20px', background: isDark ? 'rgba(255,255,255,0.04)' : 'rgba(255,255,255,0.5)',
